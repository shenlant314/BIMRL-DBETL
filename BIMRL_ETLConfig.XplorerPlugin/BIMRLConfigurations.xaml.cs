...
namespace BIMRL.BIMRL_ETLConfig
{
   ...
   /// </summary>
#if ORACLE
   [XplorerUiElement(PluginWindowUiContainerEnum.Dialog, PluginWindowActivation.OnMenu, "BIMRL ETL Configurations (Oracle)")]
#endif
#if POSTGRES
   [XplorerUiElement(PluginWindowUiContainerEnum.Dialog, PluginWindowActivation.OnMenu, "BIMRL ETL Configurations (PostgreSQL)")]
#endif
   public partial class BIMRLConfigurations : Window, IXbimXplorerPluginWindow
   {
...
#endif
#if POSTGRES
         string DBUserID = TextBox_DBUserID.Text;
#endif
      ...
      private void BIMRL_Configurations_Loaded(object sender, RoutedEventArgs e)
      {
         ...
         TextBox_DBConn.Text = DBOperation.DBConnectstring;
#if ORACLE
      ...
      private static void OnSelectedEntityChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
      {
         ...
         var ctrl = d as BIMRLConfigurations;
         if (ctrl != null)
         {
