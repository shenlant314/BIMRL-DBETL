...
namespace BIMRL.Common
{
   ...
   //{
   //    public List<Point3DLW> outerbound { get; set; }
   //  public List<List<Point3DLW>> innerbound { get; set; }
   //  public Face3DLW(Face3D f3d)
   //  {
   //     outerbound = new List<Point3DLW>();
   //     foreach (Point3D p in f3d.verticesWithHoles[0])
   //        outerbound.Add(new Point3DLW(p));

   //     if (f3d.verticesWithHoles.Count > 1)
   //     {
   //        innerbound = new List<List<Point3DLW>>();
   //        for (int i = 1; i < f3d.verticesWithHoles.Count; ++i)
   //        {
   //           List<Point3DLW> hole = new List<Point3DLW>();
   //           foreach (Point3D p in f3d.verticesWithHoles[i])
   //              hole.Add(new Point3DLW(p));
   //           innerbound.Add(hole);
   //        }
   //     }
   //  }
